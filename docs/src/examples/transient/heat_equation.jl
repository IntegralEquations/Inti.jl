...
```math
\left(\frac12 + K \right) [\sigma] = g - u_p \;\; \tag{D4},
```
"""
...
# ╔═╡ 8fffe2b3-437b-49f7-812d-ad66fae7b542
inival2d(x,y) = exp(-5(x^2+y^2))

# ╔═╡ 218e2978-5388-4aec-a48f-73bc450145a3
begin
	# Initial Condition
	u₀(x,y) = 1.0 # 2*sin(x)*sin(2*y) + 3*sin(4*x)*sin(5*y)
	f = map(Ω_quad) do q
		x, y = q.coords
		return u₀(x,y) # return x^2 + y^2 < 0.2 ? u₀(x, y) : 0.0
	end
	# Boundary Conditions
	bc(x) = 0.0 # time dependent for future cases
...
manifest_format = "2.0"
project_hash = "5dea9eae5cebec2456d8f8d61c484ccacaa33456"
...
git-tree-sha1 = "2ec79f6042de49d2521dcc72a120a33f6eab5e78"
...
git-tree-sha1 = "0b6018d17ffc9a9d1b14d934d1bc17dce80feb5c"
