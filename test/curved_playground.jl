...
for elind = 1:nvol_els
    ...
    if length(verts_on_bdry) > 1
        ...
        # Nonlinear map
        Φₖ_l2 = (x₁, x₂) -> (x₁ + x₂)^4 * (ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂)) - πₖ²ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂))) + (x₁ + x₂)^2*(πₖ²ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂)) - πₖ¹ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂)))
        Φₖ_l2_der_x1 = (x₁, x₂) -> (4*(x₁ + x₂)^3 * (ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂)) - πₖ²ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂))) + 2*(x₁ + x₂) * ( πₖ²ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂)) - πₖ¹ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂)))) + ((x₁ + x₂)^4 * (ψ_der((x₁*α₁ + x₂*α₂)/(x₁ + x₂)) - πₖ²ψ_der((x₁*α₁ + x₂*α₂)/(x₁ + x₂))) + (x₁ + x₂)^2*(πₖ²ψ_der((x₁*α₁ + x₂*α₂)/(x₁ + x₂)) - πₖ¹ψ_der((x₁*α₁ + x₂*α₂)/(x₁ + x₂)))) * ( α₁/(x₁ + x₂) - (x₁*α₁ + x₂*α₂)/(x₁ + x₂)^2 )
        Φₖ_l2_der_x2 = (x₁, x₂) -> (4*(x₁ + x₂)^3 * (ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂)) - πₖ²ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂))) + 2*(x₁ + x₂) * ( πₖ²ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂)) - πₖ¹ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂)))) + ((x₁ + x₂)^4 * (ψ_der((x₁*α₁ + x₂*α₂)/(x₁ + x₂)) - πₖ²ψ_der((x₁*α₁ + x₂*α₂)/(x₁ + x₂))) + (x₁ + x₂)^2*(πₖ²ψ_der((x₁*α₁ + x₂*α₂)/(x₁ + x₂)) - πₖ¹ψ_der((x₁*α₁ + x₂*α₂)/(x₁ + x₂)))) * ( α₂/(x₁ + x₂) - (x₁*α₁ + x₂*α₂)/(x₁ + x₂)^2 )

        # l = 3
        Φₖ = (x₁, x₂) -> (x₁ + x₂)^5 * (ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂)) - πₖ³ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂))) + (x₁ + x₂)^2*(πₖ²ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂)) - πₖ¹ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂))) + (x₁ + x₂)^3*(πₖ³ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂)) - πₖ²ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂)))
        Φₖ_der_x1 = (x₁, x₂) -> (5*(x₁ + x₂)^4 * (ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂)) - πₖ³ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂))) + 2*(x₁ + x₂)*(πₖ²ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂)) - πₖ¹ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂))) + 3*(x₁ + x₂)^2*(πₖ³ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂)) - πₖ²ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂)))) + ((x₁ + x₂)^5 * (ψ_der((x₁*α₁ + x₂*α₂)/(x₁ + x₂)) - πₖ³ψ_der((x₁*α₁ + x₂*α₂)/(x₁ + x₂))) + (x₁ + x₂)^2*(πₖ²ψ_der((x₁*α₁ + x₂*α₂)/(x₁ + x₂)) - πₖ¹ψ_der((x₁*α₁ + x₂*α₂)/(x₁ + x₂))) + (x₁ + x₂)^3*(πₖ³ψ_der((x₁*α₁ + x₂*α₂)/(x₁ + x₂)) - πₖ²ψ_der((x₁*α₁ + x₂*α₂)/(x₁ + x₂)))) * ( α₁/(x₁ + x₂) - (x₁*α₁ + x₂*α₂)/(x₁ + x₂)^2 )
        Φₖ_der_x2 = (x₁, x₂) -> (5*(x₁ + x₂)^4 * (ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂)) - πₖ³ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂))) + 2*(x₁ + x₂)*(πₖ²ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂)) - πₖ¹ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂))) + 3*(x₁ + x₂)^2*(πₖ³ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂)) - πₖ²ψ((x₁*α₁ + x₂*α₂)/(x₁ + x₂)))) + ((x₁ + x₂)^5 * (ψ_der((x₁*α₁ + x₂*α₂)/(x₁ + x₂)) - πₖ³ψ_der((x₁*α₁ + x₂*α₂)/(x₁ + x₂))) + (x₁ + x₂)^2*(πₖ²ψ_der((x₁*α₁ + x₂*α₂)/(x₁ + x₂)) - πₖ¹ψ_der((x₁*α₁ + x₂*α₂)/(x₁ + x₂))) + (x₁ + x₂)^3*(πₖ³ψ_der((x₁*α₁ + x₂*α₂)/(x₁ + x₂)) - πₖ²ψ_der((x₁*α₁ + x₂*α₂)/(x₁ + x₂)))) * ( α₂/(x₁ + x₂) - (x₁*α₁ + x₂*α₂)/(x₁ + x₂)^2 )
    ...
    for q in 1:nq
        global circarea
        circarea += Q[2][q] * abs(det(Jₖ_Z(Q[1][q][1], Q[1][q][2])))
    end
end
